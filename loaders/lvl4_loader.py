...
class Lvl4InputDataset(Dataset):
        ...
        if self.preload:
            ...
            # Save pickle file if not
                ...
                if self.metadata is None:
                    _, self.metadata = self._create_lvl3_latents()
    ...
    def _create_lvl3_latents(self):
        ...
        loader = DataLoader(self.lvl3_dataset, batch_size=1)
    ...
    def _compute_latent_dims(self):
        ...
        length = SLICE_LENGTH
        for dim_change in self.lvl3_vqvae.channel_dim_change_list:
            length /= dim_change
        width = self.lvl3_vqvae.latent_depth
