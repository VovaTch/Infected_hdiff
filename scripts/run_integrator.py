...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="config/integrator_config.yaml",
    ...
    parser.add_argument(
        ...
        "--save_path",
        type=str,
        default="src/output/sound/sample.mp3",
        help="Save path of the resulting MP3 file.",
    )
    parser.add_argument(
        "--min_time", type=float, default=270, help="Minimum track time in seconds."
    )
    parser.add_argument(
        "--max_time", type=float, default=600, help="Maximum track time in seconds."
    )
