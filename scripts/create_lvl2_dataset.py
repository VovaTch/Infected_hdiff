...
from loaders.lvl2_loader import Lvl2InputDataset, Lvl1VQVariationalAutoEncoder
...
def main(args):
    ...
    dataset = Lvl2InputDataset(**cfg_2, device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--resume', type=str, default='model_weights/lvl1_vqvae.yaml',
